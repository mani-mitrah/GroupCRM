...
$url = 'https://crm.ontimegroup.com/api/v1/lead/zoho_fetch_booking';  // Replace with your API endpoint
...
// For DLD
// Define the API endpoint
$url = 'https://crm.ontimegroup.com/api/v1/lead/zoho_fetch_dld_booking';  // Replace with your API endpoint
