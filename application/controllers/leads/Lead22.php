...
public function besmart_new()
        ...
        if ($this->verify_min_level(1)) {
            if (isset($_POST['submit'])) {
                ...
                if ($payment_type == "online") {
                    ...
                    $update = $this->mcommon->common_edit("leads", array("lead_status" => 308, "pos_pmt_number" => $raw_salesorder), array("id" => $lead_id));
                    // echo "There Update--> ".$raw_salesorder." <==> ".$lead_id." ==> ".$update;
                    // echo "<br>".$so_order;
                    // exit();
    ...
    public function view($lead_id)
    {
        if ($this->verify_min_level(1)) {
            ...
            $view_data["payment_histories"] = $this->db->from("lead_action_log")->join("leads","leads.id=lead_action_log.lead_id")->where("(leads.id=".$lead_id." or leads.lead_parent_id=".$lead_id.")")->where_in("lead_action_log.action_id",[412,415,416,417,418,420,421])->get()->result_array();
        ...
        if ($this->verify_min_level(1)) {
            ...
            if (isset($_POST['action_payment'])) {
                ...
                if ($payment_type == "online") {
                    ...
                    $update = $this->mcommon->common_edit("leads", array("lead_status" => 311), array("id" => $lead_id));
        ...
        if ($this->verify_min_level(1)) {
            ...
            if (isset($_POST['action_payment'])) {
                ...
                if ($payment_type == "online") {
                    ...
                    $update = $this->mcommon->common_edit("leads", array("lead_status" => $lead_action_vid, "pos_salesorder" => $raw_salesorder, "pos_pmt_number" => $raw_salesorder), array("id" => $lead_id));
                    // exit();
