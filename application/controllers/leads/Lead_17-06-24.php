        ...
        if ($this->verify_min_level(1)) {
            ...
            if (!empty($category_array)) {
                ...
                if ($this->auth_user_role > 5) {
                    ...
                    $view_data['created_leads'] = $this->leads_model->created_leads();
                } else {
    ...
    public function action_addpayment($lead_id)
    {
        if ($this->verify_min_level(1)) {
            ...
            if (isset($_POST['action_payment'])) {
                ...
                $this->mcommon->common_edit("leads", array("additional_govt_fee" => $this->input->post('amount_payment'),"ad_gov_fee"=>$ad_gov_fee,"ad_typing_fees"=>$ad_typing_fees,"ad_vendor_com"=>$ad_vendor_com,"ad_online_charge"=>$ad_online_charge,"ad_tax"=>$ad_tax), array("id" => $sub_lead_id));
                if ($service_name != null) {
                    // print_r($service_name);
                    // print_r($bot_id);
                    // exit();
