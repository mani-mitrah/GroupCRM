...
class Business extends MY_Controller
{
	...
	public function index()
	{
		if ($this->verify_min_level(1)) 
		{
			...
			{
		    	//$view_data['enquiries'] = $this->mcommon->specific_fields_records_all('enquiry',array('website_id'=>504, 'enquiry'=>2));
		    	$view_data['enquiries'] = $this->app_model->complaints(504);
			}
		    else
		    {
		    	$view_data['enquiries'] = $this->app_model->csa_complaints(504);	
		    }

			$data = array(
				'page_title' => 'Complaints',
				'title' => 'Complaints',
				'content' => $this->load->view('pages/complaints/business/list', $view_data, TRUE),
			);
	...
	public function assign()
	{
		if ($this->verify_min_level(1)) 
		{
			...
			if($this->auth_user_role==1 || $this->auth_user_role==6)
			{
		    	$view_data['enquiries'] = $this->app_model->unassigned_complaints(504);
		    	$view_data['website_details'] = $this->mcommon->specific_row('ontime_websites', array('id'=>'504'));
				...
				$data = array(
					...
					'content' => $this->load->view('pages/complaints/business/unassigned_list', $view_data, TRUE),
				);
				$this->load->view('template/full_template', $data);
			}
		} 
	...
	public function view()
	{
		if ($this->verify_min_level(1)) 
		{
			...
			$view_page_url = 'complaints/business/view/?id=';
			$enquiry_type=2;
