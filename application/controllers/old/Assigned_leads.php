...
class Assigned_leads extends MY_Controller
{
	...
	public function index()
	{
		if( $this->verify_min_level(1))
		{
			...
			$data = array(
				...
				'content' => $this->load->view('pages/assigned_leads/view', $view_data, TRUE),
			);
	...
	public function user_lead(){
        ...
        $this->db->join("assigned_enquriy as ae","ae.service_id=e.id");
