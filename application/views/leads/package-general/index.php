                    ...
                    <div class="page-title-wrapper">
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <span class="d-inline-block">General Package List</span>
                                </div>
                                    ...
                                    <nav class="" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="active breadcrumb-item">
                                                <a href="javascript:void(0);">General Package List</a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                        ...
                        <div class="page-title-actions">
                            <div class="d-inline-block dropdown">
                                <a href="<?php echo base_url(); ?>/leads/package/generalnew">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo $pack["package_category_name"]; ?></td>
                                                                 <td><?php echo $pack["payment_type"]; ?></td> 
                                                                <td><?php echo $pack["branch_name"]; ?></td>
                                                                <td><?php echo $pack["package_description"]; ?></td>
                                                                <td><?php echo $pack["package_amount"]; ?></td>
                                                                <td><?php echo $pack["package_service_count"]; ?></td>
                                                                <td><?php echo ($pack["is_active"] == 1) ? 'Active' : "Inactive";; ?></td>
                                                                <td><?php echo $pack["created_at"]; ?></td>
                                                                <td><?php echo $pack["updated_at"]; ?></td>
                                                                <td>
                                                                    <a href="<?php echo base_url()?>/leads/package/generaledit?id=<?php echo $pack["package_id"]; ?>"><button class="btn btn-primary" title="edit"><i class="fa fa-edit"></i></button></a> 
                                                                    <a href="<?php echo base_url()?>/leads/package/generaledit?id=<?php echo $pack["package_id"]; ?>&action=duplicate"><button class="btn btn-primary" title="clone"><i class="fa fa fa-clone"></i></button></a>
