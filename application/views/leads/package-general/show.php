...
<div class="row page-titles mx-0">
    ...
    <!-- <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
        <a class="btn btn-primary waves-effect waves-light float-right"
            href="<?php echo base_url(); ?>leads/settings/packages/add/">
                ...
                <table id="datatable" class="table table-bordered dt-responsive nowrap"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><strong><?php echo $value['package_name'];?></strong></td>
                            ...
                            <!-- <td><a href="<?php echo base_url(); ?>leads/settings/packages/edit/<?php echo $value['id'];?>"
                                    class="btn btn-sm btn-primary">Edit</a>&nbsp;<a
                                    href="<?php echo base_url(); ?>leads/settings/packages/status_change/<?php echo $value['id'];?>"
