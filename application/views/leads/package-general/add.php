...
<div class="app-main">
    <div class="app-main__outer">
        <div class="app-main__inner p-0">
                ...
                <div class="container fiori-container">
                    <div class="page-title-wrapper">
                        <div class="page-title-heading">
                            <div>
                                New General Package Creation
                                <div class="page-title-subheading">General Package creation with the Services and Amount details
                                </div>
                            </div>
                        </div>
            ...
            <div class="fiori-container container mb-5">
                <div class="app-inner-layout chat-layout justify-content-center mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php } ?>
                            <form action="<?php echo base_url(); ?>leads/package/generalnew" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="under_branch" class="form-control" required>
                                                        <option value="" default disabled selected>--Select Branch--</option>
                                                        <?php
                                                        foreach ($branches as $branch) {
                                                            if ($branch['branch_code'] == 106 || $branch['branch_code'] == 109) continue;
                                                        ?>
