<div class="row page-titles mx-0">
    <div class="col-sm-6 p-md-0">
        <div class="welcome-text">
            ...
            <span>Add new package service</span>
        </div>
    </div>
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-12">
                ...
                <?php } ?>
                <form action="<?php echo base_url(); ?>leads/settings/pservices/add" method="post">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Government Fee" name="govt_fee" required="">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Typing Fee <span class="text-danger required">*</span>
                                </label>
                                <input type="text" class="form-control" placeholder="Enter Typing Fee" name="typing_fee" required="">
                            </div>
                        </div>
                    </div>
