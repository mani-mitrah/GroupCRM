                    ...
                    <div class="page-title-wrapper">
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <span class="d-inline-block">Package List</span>
                                </div>
                        ...
                        <div class="page-title-actions">
                            <div class="d-inline-block dropdown">
                                <a href="<?php echo base_url()?>/leads/package/labnew">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="<?php echo base_url()?>/leads/package/labedit?id=<?php echo $pack["package_id"]; ?>"><button class="btn btn-primary" title="edit"><i class="fa fa-edit"></i></button></a> 
                                                                    <a href="<?php echo base_url()?>/leads/package/labedit?id=<?php echo $pack["package_id"]; ?>&action=duplicate"><button class="btn btn-primary" title="clone"><i class="fa fa fa-clone"></i></button></a>
