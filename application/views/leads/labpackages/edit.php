                    ...
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">
                            <div class="d-inline-block dropdown">
                                ...
                                <a href="<?php echo base_url() ?>/leads/package/labindex">
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row service-row" <?php if ($key == 0) { ?> id="service_row" <?php } ?>>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-7">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" step="0.01" min="0" name="typing_fee[]" value="<?php echo $detail["typing_fee"]; ?>" required class="form-control" placeholder="Typing Fee" aria-describedby="helpId">
                                                            </div>
                                                        </div>
                                                        <div class="col-5">
                                                            <div class="form-group">
                                                                <label for="">Govt Fee&nbsp;<span class="text-danger required">*</span></label>
                                                                <input type="number" step="0.01" min="0" name="govt_fee[]" value="<?php echo $detail["govt_fee"]; ?>" required class="form-control" placeholder="Govt Fee" aria-describedby="helpId">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-1 pl-0">
                                                    <div class="form-group text-center">
                                                        ...
                                                        <input type="text" min="0" step="0.01" name="card_amount[]" value="<?php echo $detail["card_amount"]; ?>" class="form-control p-0 text-center" placeholder="Cart Amount %" readonly required>
                                                    </div>
                                                </div>
                                                <div class="col-1 p-0">
                                                    <div class="form-group text-center">
                                                        <label for="">Total&nbsp;<span class="text-danger required">*</span></label>
                                                        <input type="text" min="0" step="0.01" name="total[]" value="<?php echo $detail["total"]; ?>" class="form-control p-0 text-center" placeholder="Total" aria-describedby="helpId" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-1">
                                                    <div class="form-group">
                                ...
                                <div class="row justify-content-end mt-3">
                                    ...
                                    <div class="col-2">
                                        <div class="form-group">
                                            <input type="number" name="package_amount" step="0.01" class="form-control border-dark" placeholder="Package Total Amount" aria-describedby="helpId" readonly>
                                        </div>
                                    </div>
                                    <div class="col-1">
...
<script>
    ...
    function init() {
        ...
        $("#service_row .add-action").on("click", function(e) {
            ...
            newService.find("input[name='service_id[]']").val("");
