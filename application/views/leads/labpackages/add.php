                ...
                <div class="app-inner-layout chat-layout justify-content-center mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php } ?>
                            <form action="<?php echo base_url(); ?>leads/package/labnew" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="under_branch" class="form-control" required>
                                                        <option value="111" selected default>Tanfeeth</option>
                                                        <!-- <php
                                        ...
                                        <div class="row service-row" id="service_row">
                                                ...
                                                <div class="row">
                                                    <div class="col-7">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" step="0.01" min="0" value="0" name="typing_fee[]" required class="form-control" placeholder="Typing Fee" aria-describedby="helpId">
                                                        </div>
                                                    </div>
                                                    <div class="col-5">
                                                        <div class="form-group">
                                                            <label for="">Govt Fee&nbsp;<span class="text-danger required">*</span></label>
                                                            <input type="number" step="0.01" min="0" value="0" name="govt_fee[]" required class="form-control" placeholder="Govt Fee" aria-describedby="helpId">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-1 pl-0">
                                                <div class="form-group text-center">
                                                    ...
                                                    <input type="text" min="0" value="0" name="card_amount[]" class="form-control p-0 text-center" placeholder="Cart Amount %" readonly required>
                                                </div>
                                            </div>
                                            <div class="col-1 p-0">
                                                <div class="form-group text-center">
                                                    <label for="">Total&nbsp;<span class="text-danger required">*</span></label>
                                                    <input type="text" value="0" name="total[]" class="form-control p-0 text-center" placeholder="Total" aria-describedby="helpId" readonly>
                                                </div>
                                            </div>
                                            <div class="col-1">
                                                <div class="form-group">
                                ...
                                <div class="row justify-content-end mt-3">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            <input type="number" step="0.01" name="package_amount" class="form-control border-dark" placeholder="Package Total Amount" aria-describedby="helpId" readonly>
                                        </div>
                                    </div>
                                    <div class="col-2">
 ...
 function directInvoice() {
    ...
    function init() {
        ...
        $("#service_row .add-action").on("click", function(e) {
            e.preventDefault();
            $(".services").append("<div class='row service-row'>" + service + "</div>"); directInvoice();
            init();
        });
