                    ...
                    <div class="page-title-wrapper">
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <span class="d-inline-block">Package List - Baraha Van</span>
                                </div>
                                    ...
                                    <nav class="" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="active breadcrumb-item">
                                                <a href="javascript:void(0);">Package List</a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                        ...
                        <div class="page-title-actions">
                            <div class="d-inline-block dropdown">
                                <a href="<?php echo base_url(); ?>/leads/package/newbarahavan">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo ($pack["is_active"] == 1) ? 'Active' : "Inactive"; ?>
                                                                <td><?php echo $pack["created_at"]; ?></td>
                                                                <td><?php echo $pack["updated_at"]; ?></td>
                                                                <td>
                                                                    
                                                                    <a href="<?php echo base_url()?>/leads/package/editbarahavan?id=<?php echo $pack["package_id"]; ?>"><button class="btn btn-primary" title="edit"><i class="fa fa-edit"></i></button></a> 
                                                                    <!-- <a href="<?php echo base_url()?>/leads/package/edit?id=<?php echo $pack["package_id"]; ?>&action=duplicate"><button class="btn btn-primary" title="clone"><i class="fa fa fa-clone"></i></button></a> -->
