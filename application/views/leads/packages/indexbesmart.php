                    ...
                    <div class="page-title-wrapper">
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <span class="d-inline-block">Package List - Be Smart</span>
                                </div>
                        ...
                        <div class="page-title-actions">
                            <div class="d-inline-block dropdown">
                                <a href="<?php echo base_url(); ?>/leads/package/newbesmart">
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="<?php echo base_url()?>/leads/package/editbesmart?id=<?php echo $pack["package_id"]; ?>"><button class="btn btn-primary" title="edit"><i class="fa fa-edit"></i></button></a> 
