                    ...
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">
                            <div class="d-inline-block dropdown">
                                ...
                                <a href="<?php echo base_url(); ?>/leads/package/barahavan_packages">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="under_branch" class="form-control" required>
                                                        <option value="138" selected default>Baraha Van</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                            ...
                                            <div class="row service-row" <?php if ($key == 0) { ?> id="service_row" <?php } ?>>
                                                ...
                                                <div class="col-2 d-flex">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="service_name[]" value="<?php echo $detail["service_name"]; ?>" class="form-control" required placeholder="Service Name" aria-describedby="helpId">
                                                    </div>
                                                </div>
                                                <div class="col-3">
                                                    <div class="row">
                                                        <div class="col-7">
                                                            <div class="form-group">
                                                                <label for="">Typing Fee(Incl VAT)&nbsp;<span class="text-danger required">*</span></label>
                                ...
                                <div class="row justify-content-end mt-3">
                                    ...
                                    <div class="col-1">
                                        <div class="form-group mb-0">
                                             <button type="submit" name="submit[]" value="Save" class="btn btn-primary form-control" placeholder="" aria-describedby="helpId">Save Changes</button>
                                     ...
                                     <div class="col-2">
                                        <div class="form-group mb-0">
                                          <button type="submit" name="submit[]" value="Save As" class="btn btn-primary form-control" placeholder="" aria-describedby="helpId">Save As New Package</button>
