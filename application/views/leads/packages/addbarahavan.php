                    ...
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">
                            <div class="d-inline-block dropdown">
                                <a href="/leads/barahavan_packages">
                ...
                <div class="app-inner-layout chat-layout justify-content-center mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php } ?>
                            <form action="<?php echo base_url(); ?>leads/package/newbarahavan" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-12 p-0 m-0 services">
                                        <div class="row service-row" id="service_row">
                                            <div class="col-2 d-flex">
                                                <div class="m-auto count"></div>
                                                <div class="form-group">
                                                    <label for="">Service Name&nbsp;<span class="text-danger required">*</span></label>
                                                    <input type="text" name="service_name[]" class="form-control" required placeholder="Service Name" aria-describedby="helpId">
                                                </div>
                                            </div>
...
<script>
    ...
    function init() {
        ...
        $("#service_row .add-action").on("click", function(e) {
            e.preventDefault();
            $(".services").append("<div class='row service-row'>" + service + "</div>");
            directInvoice();
            init();
        });
