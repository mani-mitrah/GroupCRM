                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <span class="d-inline-block">OntimeVisa Leads</span>
                                </div>
                                    ...
                                    <nav class="" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="active breadcrumb-item">
                                                <a href="javascript:void(0);">OntimeVisa Leads</a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                                        ...
                                        <div class="main-card mb-3 card mt-4">
                                            <div class="card-body table-responsive">
                                                ...
                                                <table style="width: 100%;" id="dTtable" class="table dTtable table-hover table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        foreach ($ontimevisa_leads->data as $value) {
                                                            // echo "<pre>";
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td><?php 
                                                                $created_crm_user_data = get_crm_user_display_data($value->id, 'ontimevisa');
                                                                ...
                                                                <?php $created_user_group = get_user_created_group($value->id, 'ontimevisa'); ?>
                                                                <td><?php echo $created_user_group; ?></td>
                                                                <td><?php echo $value->created_at; ?></td>
                                                                <td><?php echo $value->updated_at; ?></td>
                                                                <!-- <td><?php //echo $value->zoho_response; 
                                                                            ?></td> -->
                                                                <td><a href="<?php echo base_url(); ?>leads/lead/get_ontimevisa_details/<?php echo $value->id; ?>"
