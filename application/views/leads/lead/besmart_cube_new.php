                                ...
                                <div class="row">
                                                ...
                                                <div class="row m-0 service-row" id="service-row">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="govt_fee[]" id="" class="form-control" placeholder="" aria-describedby="helpId" >
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-2">
                                                        <div class="form-group">
                                                            <label for="">Typing Fee (Incl Vat)</label>
                                                            <input type="number" name="typing_fee[]" id="" class="form-control" placeholder="" aria-describedby="helpId" >
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="sub_total[]" id="" class="form-control" placeholder="" aria-describedby="helpId"  required>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="amount_payment" id="amount_payment" class="form-control" placeholder="Subtotal Amount" aria-describedby="helpId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-right">
                                            ...
                                            <input type="submit" class="btn btn-lg btn-primary btn-square p-3 pl-5 pr-5" name="submit" value="CREATE" />
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        $('#payment_type2').change(function() {
                            ...
                            if (selectedPaymentType !== '') {
                                ...
                                $('#service_addition').select2({
                                    ...
                                    ajax: {
                                        url: '<?php echo base_url()?>/leads/package/new_getPackageDetails?payment_type=' + is_payment_type + '&branch=' + is_branch+ '&search=' + this.value,
                                        dataType: 'json'
                                    }
                                });
