                    ...
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">
                            <div class="d-inline-block dropdown">
                                ...
                                ?>
                                    <a href="/leads/lead/ontimevisalist">
                ...
                <div class="app-inner-layout chat-layout justify-content-center mt-5">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php  }?>
                            <form action="<?php echo base_url(); ?>leads/lead/ontimevisanew" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-12">
                                     ...
                                     <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="business_activity" id="business_activity"
                                                ...
                                                <option value="Schengen Checklist" >Schengen Checklist</option>
                                                <option value="USA Checklist" >USA Checklist</option>
                                                <option value="UK Checklist" >UK Checklist</option>
