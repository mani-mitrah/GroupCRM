        ...
        <div class="app-main__inner p-0">
                ...
                <div class="container fiori-container">
                    <div class="page-title-wrapper">
                        <div class="page-title-heading">
                            <div>
                                Golden Cube - Lead #<?php echo $lead["id"];?>
                                <div class="page-title-subheading">Creation of New Sale - Lead</div>
                            </div>
                        </div>
            ...
            <div class="fiori-container container">
                <div class="app-inner-layout chat-layout justify-content-center mt-5">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php } ?>
                            <form id="createLeadForm" action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="package_id" id="package_id" required autofocus>
                                                <option value="">-- Select Package --</option>
                                                <?php
                                                foreach ($packages as $key => $value) {
                                                ?>
                                                    <option data-amount="<?php echo $value["no_card_amount"]; ?>" value="<?php echo $value['package_id']; ?>">
                                                        <?php echo $value['package_name'] . " - " . $value["no_card_amount"] . "AED"; ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" required="" name="lead_name" value="<?php echo $lead["customer_name"]; ?>" readonly autofocus>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Country Code&nbsp;<span class="text-danger required">*</span></label>
                                            <input type="text" pattern="+[0-9]" class="form-control" title="Country Code like +971" required="" name="lead_country_code" value="<?php echo $lead["customer_country_code"]; ?>" readonly  value="+971">
                                        </div>
                                    </div>
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <label>Customer contact number without country code&nbsp;<span class="text-danger required">*</span></label>
                                            <input type="number" class="form-control" required="" pattern="[5|6][0-9]{8}" name="lead_contact" value="<?php echo $lead["customer_mobile"]; ?>" readonly >
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Customer Email Address</label>
                                            <input type="email" class="form-control" name="lead_email" value="<?php echo $lead["customer_email"]; ?>" readonly >
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Remarks(in English/Arabic)&nbsp;<span class="text-danger required">*</span></label>
                                            <textarea rows="7" class="form-control" required="" name="lead_remarks" required readonly></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                ...
                <script type="text/javascript">
                    ...
                    $('[name="lead_remarks"]').html(`<?php echo strip_tags(str_replace("<br>","\r",str_replace("<br\>","\r",str_replace("<br/>","\r",$lead["remarks"])))); ?>`);
                    ...
                    $("#package_id").change(function(e) {
                        ...
                        $.ajax({
                            url: "/leads/package/getPackageDetails?package_id=" + package_id,
                            beforeSend: function() {
                    ...
                    $('#service_addition').select2({
                        ...
                        ajax: {
                            url: '/leads/package/getGCPackageDetailsAll',
                            dataType: 'json'
                    ...
                    $("#service_addition").change(function() {
                        ...
                        $.ajax({
                            url: "/leads/package/getPackageDetail?service_id=" + service_id,
                            beforeSend: function() {
                                Swal.fire({
...
<script>
    ...
    $(document).ready(function() {
        $("#createLeadForm").submit(function(e){
            let paymentType = $(this).find('input[name=payment_type]:checked').val();
            let country_code = $('#createLeadForm').find("#lead_country_code").val();
            let type = country_code == '+971'?'mobile':'email';
            let customer_mobile = $('#createLeadForm').find("input[name=lead_contact]").val();
            let customer_email = $('#createLeadForm').find("input[name=lead_email]").val();
            let customer_name = $('#createLeadForm').find("input[name=lead_name]").val();
            let customer_id = '';
