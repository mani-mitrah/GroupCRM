                                    ...
                                    <nav class="" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="active breadcrumb-item">
                                                <a href="javascript:void(0);">Call Centre Contacts</a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                    ...
                    <div class="app-inner-layout__wrapper">
                        <div class="app-inner-layout__content">
                            <div class="tab-content container-fluid">
                                    <div class="tab-pane tabs-animation fade show  <?php echo $this->auth_user_role > 2 ? 'active':''; ?>" id="created" role="tabpanel">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($unassigned_leads as $key => $value) { ?>
                                                                <tr id="o<?php echo $value['id']; ?>">
                                                                    ...
                                                                    <td>
                                                                        <a href="<?php echo base_url(); ?>leads/lead/view/<?php echo $value['id']; ?>" class="btn btn-sm btn-primary">View</a>
                                                                        <button class="btn btn-sm btn-info assignBtn" data-id="<?php echo $value['id']; ?>">Assign to me</button>
                                                                    </td>
                                                                </tr>
                                                            <?php
                                                            }
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#unassigned_dTtable').on('click','.assignBtn', function (e) {
            e.preventDefault();
            let user_id = <?php echo $this->auth_user_id; ?>;
            swal.fire({
                icon: "info",
                text: "Are you sure you can assign this lead to yourself?",
