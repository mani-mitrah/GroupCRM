                ...
                <div class="app-inner-layout chat-layout justify-content-center mt-5">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php } ?>
                            <form id="createLeadForm" action="<?php echo base_url(); ?>leads/lead/lab_new" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="branch_id" value="111">
                                <input type="hidden" name="lead_type" value="package">
                                <input type="hidden" name="assign_group" value="84">
