            ...
            <div class="fiori-container container">
                <div class="app-inner-layout chat-layout justify-content-center mt-5">
                        ...
                        $(document).ready(function() {
                            ...
                            $('#btnAddNewAttachment').click(function(e) {
                                ...
                                var newDiv = $(
                                    ...
                                    '<div class="col-md-5"><input type="file" class="form-control attachment-file" required="" multiple  name="attachments_lead[' + attachmentIndex + '][]" placeholder="" />' + '<small class="text-muted file-count-msg">No files selected</small>' + '<small class="text-danger file-size-error  d-none">One or more files exceed 5 MB limit.</small></div>' +
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php } ?>
                            <form id="createLeadForm" action="<?php echo base_url(); ?>leads/lead/golden_cube_new" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6" id="applicant_name_group" style="display: none;">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control selected_field" required="" id="applicant_name" name="applicant_name" autofocus>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Customer Name&nbsp;<span class="text-danger required">*</span></label>
                                            <input type="text" class="form-control selected_field" required="" id="lead_name" name="lead_name" autofocus>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" class="form-control selected_field" required="" maxlength="10" name="lead_contact" id="lead_contact"
                                                pattern="^[0-9]{7,}$" required="" title="Numbers Only allowed">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Customer Email Address <span class="text-danger required">*</span></label>
                                            <input id="email" type="email" class="form-control selected_field" name="lead_email">
                                            <span id="email_error" required="" class="text-danger"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                ...
                <script>
                    ...
                    function get_dataset(package_id){
                        var pay_type = $("[name='payment_type']:checked").val();
                        var package_pay_type = $("#package_id option:selected").data("payment-type");
...
<script>
    ...
    $(document).ready(function() {
        $("#createLeadForm").submit(function(e){
            ...
            let country_code = $('#createLeadForm').find("#lead_country_code").val();
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div style="direction: rtl; text-align: right">
            <p class="font-weight-bold text-underline">إقرارت و تعهدات</p>
            <p class="mb-0">1. اقر انا مقدم الطلب ان التزم بتعليمات التقديم للحصول على الإقامة بإمارة دبي في دولة الامارات العربية المتحدة و الموضحة بهذا الطلب لدى مركز دائرة الأراضي والأملاك "قولدن كيوب" و المرخص لتقديم خدمات المستثمرين العقاريين ومرافقيهم والمعاملات ذات الصلة.</p>
            <p class="mb-0">2. اتعهد بتقديم كافة البيانات بشكل صحيح وان التزم بتزويد المركز بكافة التفاصيل و المستندات المطلوبة بشكل كامل و صحيح.</p>
            <p class="mb-0">3. في حالة التقدم بطلب إقامة ذهبية، اقر انني انا صاحب الطلب و العلاقة ومتواجد داخل حدود دولة الامارات العربية المتحدة وقت تقديم الطلب للهجرة واتعهد بالالتزام بعدم مغادرتي الدولة )او مغادرة أي من المرافقين في حالة طلبات المرافقين( إلى حين الحصول على موافقه طلب الإقامة وطباعه طلب الهوية الإمارتية وإلا يعتبر الطلب مرفوض و ملغي و غير قابل للنزاع وغير قابل لاسترداد أية رسوم مهنية او حكومية، وفي حال إعادة التقديم للطلبات يتوجب على العميل دفع الرسوم الإضافية الحكومية، واقر ان رقم الهاتف المحلي و البريد الالكتروني المقدم مني مع الطلب يعبر عن بياناتي الشخصية و ليس بيانات أي طرف ثالث آخر، واقر بعلمي ان الإطار الزمني للإنجاز سيخضع لموافقات الجهات المعنية، و يسري هذا الشرط و كافة الاقرارات و التعهدات بهذا الطلب على أي من المرافقين في حالة التقدم بطلب نيابة عن مرافق.</p>
            <p class="mb-0">4. اتعهد بعدم زيارة المركز إلا في حالة طلب مني ذلك من خلال التواصل معي عبر بالبريد الالكتروني الذي قمت بتزويد المركز به او من خلال اتصال هاتفي إذا لزم.</p>
            <p class="mb-0">5. اتعهد بسداد جميع الرسوم كاملة مقدمًا وبعملة الدولة الدرهم الإماراتي فقط.</p>
            <p class="mb-0">6. اتعهد بسداد كافة الغرامات الناتجة عن تأخيري او افعالي.</p>
            <p class="mb-0">7. اقر انني على علم انه لا يمكن استرداد الرسوم عن الخدمات المقدمة ورسوم خدمة المركز وان أي استرداد يكون فقط عن الخدمات التي لم يتم تقديمها بعد و ذلك في غضون 30 يوما من تاريخ تقديمي لهذا الطلب فقط.</p>
            <p class="mb-0">8. اقر انني على علم انه لا يحق لي بالمطالبة برسوم الخدمة المهنية او الرسوم الحكومية للمعاملات المرفوضة من قبل الجهات الحكومية.</p>
            <p class="mb-0">9. اتعهد بعدم المطالبة بأية رسوم حكومية في حال تم تقديم المعاملات من خلال أي مركز (الفحص الطبي، الهوية الإماراتية، طلبات الهجرة) آخر وليس من خلال المركز "قولدن كيوب"</p>
            <p class="mb-0">10. اقر بموافقتي عن ان تكون لجنة دائرة الأراضي والأملاك هي الجهة المختصة بالنظر في اية نزاعات تنشأ بيني وبين المركز و تعتبر موافقتي على هذه الاقرارات و التعهدات و سدادي للمبلغ المطلوب نظير الخدمات بمثابة عقد ملزم لي لا رجعة فيه.</p>
          </div>
          <hr class="mt-5 mb-5">
          <div class="mt-2">
            <p class="font-weight-bold text-underline">Undertakings and Declarations</p>
            <p>1. I, the applicant, acknowledge that I will abide by the instructions for applying for residency in the Emirate of Dubai in the United Arab Emirates, as stated in this application at the Land and Property Department Center “Golden Cube”, which is licensed to provide services to real estate investors and their companions and related transactions.</p>
            <p>2. I undertake to provide the Center with all the required details
and documents completely and accurately.</p>
            <p>3. In the event of applying for a golden visa, I acknowledge that I am the applicant and the person in question and am present within the borders of the United Arab Emirates at the time of submitting the application for immigration and I pledge to commit myself not to leave the country (or to leave any of the dependents in the case of dependents applications) until I obtain Approval of the residence application and printing of the Emirates ID application, otherwise the application will be considered rejected, cancelled, non-disputable and non-refundable of any professional or governmental fees. In the event of re-submitting applications, the customer must pay the additional governmental fees. I acknowledge that the local phone number and email provided by me with the application represent my personal data and not the data of any other third party. I acknowledge that the time frame for completion will be subject to the approvals of the relevant authorities, and this condition and all the declarations and undertakings in this application apply to any of the dependents in the event of applying on behalf of a dependent.</p>
            <p>4. I undertake not to visit the Center unless it is required by communicating with me via the e-mail that I provided the
...
government fees due for my transaction solely in UAE Dirhams.</p>
            <p>6. I undertake to pay all fines and penalties resulting from my
actions.</p>
            <p>7. I acknowledge that I am aware that fees for services provided, and center service fees cannot be refunded and that any refund will only be for services that have not yet been provided and that this will be within 30 days from the date of my submission of this request only.</p>
            <p>8. I declare that I have no right to seek a refund for professional fees or government fees concerning services refused by the
respective government authority.</p>
            <p>9. I pledge not to request for any government fees if the transactions are submitted through any other center (medical examination, Emirates ID, immigration applications) and not through the “Golden Cube” center</p>
            <p>10. I declare my acceptance of Dubai Land Department Committee to be the sole jurisdiction for disputes, and that my consent for these undertakings and declarations are legally
