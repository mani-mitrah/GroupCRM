                ...
                <div class="app-inner-layout chat-layout justify-content-center mt-5">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php } ?>
                            <form id="createLeadForm" action="<?php echo base_url(); ?>leads/lead/lab_new_enbd" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="branch_id" value="131">
                                <input type="hidden" name="lead_type" value="package">
                                <input type="hidden" name="assign_group" value="98">
                                <input type="hidden" name="assign_to" value="732508183">
                                ...
                                <div class="row">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="sub_total[]" id="" class="form-control" placeholder="" aria-describedby="helpId" readonly required>
                                                             <input type="hidden" name="msd_key[]" id="" class="form-control" placeholder="" aria-describedby="helpId" readonly>
                                                              <input type="hidden" name="is_pos_typing_fee[]" id="" class="form-control" placeholder="" aria-describedby="helpId" readonly>
                                                              <input type="hidden" name="is_direct_invoice[]" id="" class="form-control" placeholder="" aria-describedby="helpId" readonly>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" type="radio" name="payment_type" id="" value="cash">Pay by Cash
                                                </label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
    ...
    $(document).ready(function() {
        ...
        $('.otp-input').on('paste', function(e) {
            ...
            if (/^\d{6}$/.test(pastedData)) {
                ...
                Swal.fire('Error!',"Enter Valid OTP.<br>'"+pastedData+"' is not allowed.", 'error');
            }
        });
    })
</script>