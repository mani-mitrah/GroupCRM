<div class="row page-titles mx-0">
    <div class="col-sm-6 p-md-0">
        <div class="welcome-text">
            ...
            <span>Edit action information</span>
        </div>
    </div>
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-12">
                ...
                <?php } ?>
                <form action="<?php echo base_url();?>leads/settings/actions/edit/<?php echo $default['id'];?>" method="post">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Action Name <span class="text-danger required">*</span>
                                </label>
                                <input type="text" class="form-control" placeholder="Enter Action Name" name="action_name" required value="<?php echo $default['action_name']; ?>">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
