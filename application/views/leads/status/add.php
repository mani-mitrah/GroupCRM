    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-12">
                ...
                <?php } ?>
                <form action="<?php echo base_url(); ?>leads/settings/lstatus/add" method="post">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Status Name <span class="text-danger required">*</span>
                                </label>
                                <input type="text" class="form-control" placeholder="Enter Status Name" name="status_name" required="">
                            </div>
                        </div>
                    </div>
