...
<head>
    ...
    <link href="<?php echo base_url(); ?>global/vendor/bootstrap-select/dist/css/bootstrap-select.min.css"
        rel="stylesheet">
    ...
    <link
        href="<?php echo base_url(); ?>global/vendor/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css"
        rel="stylesheet">
...
<body>
    ...
    ***********************************-->
    ...
    <script type="text/javascript"
        src="<?php echo base_url(); ?>global/vendor/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js">
    </script>
    ...
    <script
        src="<?php echo base_url(); ?>assets_new/node_modules/datatables.net-buttons-bs4/js/buttons.bootstrap4.min.js">
    </script>
    <script src="<?php echo base_url(); ?>assets_new/node_modules/datatables.net-buttons/js/buttons.html5.min.js">
    </script>
    <link rel="stylesheet"
    ...
    <script src="<?php echo base_url(); ?>global/node_modules/bootstrap/dist/js/bootstrap.min.js"></script>

    <script src="<?php echo base_url(); ?>global/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
    <script src="<?php echo base_url(); ?>global/vendor/select2/js/select2.full.min.js"></script>
    <script src="<?php echo base_url(); ?>global/js/plugins-init/select2-init.js"></script>
