                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                    ...
                    <div style="">
                      ...
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                        ...
                        <p style='font-family: sans-serif; font-size: 14px; font-weight: normal; margin-top: 10px;margin-bottom: 20px;'>
                          We would like to inform you that your <strong>Emirates ID application has been successfully printed.</strong>
                        </p>
                        <p style='font-family: sans-serif; font-size: 14px; font-weight: normal; margin-top: 10px;margin-bottom: 20px;'>
                          Our team will provide you with the printed application at the earliest opportunity.
                        </p>
                        <p style='font-family: sans-serif; font-size: 14px; font-weight: normal; margin-top: 10px;margin-bottom: 20px;'>
                        ...
                        <p style="font-family: 'dubai', sans-serif; font-size: 14px; font-weight: normal; Margin-bottom: 15px; text-align: end;">
                            نود إعلامكم بأنه قد تم طباعة طلب الهوية الإماراتية الخاص بكم بنجاح، وسيقوم فريقنا بتزويدكم به في أقرب فرصة ممكنة.
                        </p>
                        <p style="font-family: 'dubai', sans-serif; font-size: 14px; font-weight: normal; Margin-bottom: 15px; text-align: end;">
                            شاكرين لكم تعاونكم المستمر.
                        </p>
