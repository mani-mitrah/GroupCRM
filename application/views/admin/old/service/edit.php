    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-12">
                ...
                <?php } ?>
                <form action="<?php echo base_url();?>weqayati/service_hours/edit/<?php echo $default['id'];?>" method="post">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Service Hours<span class="text-danger required">*</span>
                                </label>
                                <input type="text" class="form-control" placeholder="Service Hours" name="service_hour" required value="<?php echo $default['service_hour']; ?>">
                            </div>
                        </div>
                      <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="ساعات الخدمة" name="service_hour_arabic" required value="<?php echo $default['service_hour_arabic']; ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
