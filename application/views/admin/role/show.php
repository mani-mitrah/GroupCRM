        ...
        <div class="page-title-box">
            <h4 class="page-title"><?php echo $page_title; ?>
                <a class="btn btn-primary waves-effect waves-light float-right"
                    href="<?php echo base_url(); ?>admin/role/add/">
                    <i class="mdi mdi-plus mr-2"></i> Add New Role
                </a>
            </h4>
        </div>
    </div>
                ...
                <table id="datatable" class="table table-bordered dt-responsive nowrap"
	                ...
	                ?>
                        <tr>
                            ...
                            <td><a href="<?php echo base_url(); ?>admin/role/edit/<?php echo $value->role_id;?>"
                                    class="btn btn-sm btn-success">Edit</a>&nbsp;<a
                                    href="<?php echo base_url(); ?>admin/role/status_change/<?php echo $value->role_id;?>"
