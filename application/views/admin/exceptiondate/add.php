...
<div class="row page-titles mx-0">
    <div class="col-sm-6 p-md-0">
        <div class="welcome-text">
            ...
            <span>Add new Exceptional Date</span>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="timeslot_except_date" required>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" placeholder="Description" name="timeslot_except_desc" required rows="5"></textarea>
                            </div>
                        </div>
                    </div>
                ...
                <form action="" method="post" onsubmit="return validateForm()">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Exceptional Date <span class="text-danger required">*</span></label>
                                <input type="date" class="form-control" name="timeslot_except_date">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Timeslot Description <span class="text-danger required">*</span></label>
                                <textarea class="form-control" placeholder="Description" name="timeslot_except_desc" rows="5"></textarea>
