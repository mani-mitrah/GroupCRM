<div class="row page-titles mx-0">
    <div class="col-sm-6 p-md-0">
        <div class="welcome-text">
            ...
            <span>Manage Calendar Notification</span>
        </div>
    </div>
</div>
<?php
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="<?php echo base_url(); ?>admin/calendar/edit_notification/<?php echo $value['calendar_id']; ?>" class="btn btn-sm btn-primary">Edit</a>&nbsp;
