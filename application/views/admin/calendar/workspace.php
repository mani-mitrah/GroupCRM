<div class="row page-titles mx-0">
    <div class="col-sm-6 p-md-0">
        <div class="welcome-text">
            ...
            <span>Manage Calendar Groups</span>
        </div>
    </div>
    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
        <a class="btn btn-primary waves-effect waves-light float-right" href="<?php echo base_url(); ?>admin/calendar/add/">
            <i class="mdi mdi-plus mr-2"></i> ADD NEW CALENDAR
        </a>
    </div>
</div>
<?php
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="<?php echo base_url(); ?>admin/calendar/edit/<?php echo $value['calendar_id']; ?>" class="btn btn-sm btn-primary">Edit</a>&nbsp;
