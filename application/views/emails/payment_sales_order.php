            ...
            <tr>
              <td class="wrapper" style="font-family: sans-serif; font-size: 14px; vertical-align: top; box-sizing: border-box; padding: 20px;">
                <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                  ...
                  <tr>
                    <td align="left">
                      <strong>PAYMENT DATE:</strong> <?php echo date('d/m/Y'); ?><br />
                    </td>
                    <td align="right">
                      <strong>REFERENCE NO:</strong> <?php echo $reference; ?><br />
                      <?php if ($so_order) { ?><strong>SALES ORDER #:</strong> <?php echo $so_order;
                                                                            } ?>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td colspan="2">
                      ...
                      <?php if ($mobile != "") { ?><strong>Contact</strong> - <?php echo $mobile;
                                                                            } ?>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td colspan="4">
                      ...
                      <div style="display: flex;">
                        ...
                        <div>
                          <ol style="margin: 0;padding: 0 21px;">
                            <li>Cash in Branch</li>
                            <li>Card in Branch</li>
                          </ol>
                        </div>
                      </div>
                    </td>
