...
if($enquiry_details['enquiry']==1) {
    $action_base = 'enquiries';
    $action_base_singular = 'enquiry';
} else if($enquiry_details['enquiry']==3) {
    $action_base = 'meetings';
    $action_base_singular = 'meeting';
} else if($enquiry_details['enquiry']==2) {
    $action_base = 'complaints';
    $action_base_singular = 'complaint';
}
?>
<div class="row page-titles mx-0">
    <div class="col-sm-6 p-md-0">
        <div class="welcome-text">
            <?php
            ?>
            <h4><?php echo $website_details['website_name'].' '.strtoupper($action_base); ?></h4>
            <span>Manage <?php echo $website_details['website_name'].' '.ucfirst($action_base); ?></span>
        </div>
    </div>
    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
        <a class="btn btn-primary waves-effect waves-light float-right"
            href="<?php echo base_url().''.$action_base.'/'.$website_details['short_name'].'/'; ?>">
            <i class="fa fa-back mr-2"></i> Back to <?php echo $action_base; ?>
        </a>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
        <div class="card" id="order_details_block">
            <div class="card-header">
                <h5 class="card-title"><?php echo strtoupper($action_base_singular); ?> DETAILS</h5>
            </div>
            <div class="card-body">
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <?php
                $action_url=base_url().''.$action_base.'/'.$website_details['short_name'].'/view?id='.$enquiry_details['id'];
                ?>
                <div class="row">
                    <div class="col-md-12">
                        <?php 
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" placeholder="from" readonly="" value="<?php echo $website_details['company_email']; ?>" name="from_email">
                                </div>
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="mobile_number" value="<?php echo $enquiry_details['phone']; ?>" />
                                </div>
                                <div class="form-group">
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-secondary">
                <h5 class="card-title text-white">CONFIRM / CLOSE</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
