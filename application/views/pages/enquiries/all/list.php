        ...
        <div class="card">
            ...
            ?>
                        <tr>
                            ...
                            <td><?php echo isset($last_folowup[1]) ? $last_folowup[1] : '-';
                    echo isset($last_folowup[2]) ? '<br>' . $last_folowup[2] : '-'; ?></td>
                            <!-- <td><?php echo isset($last_folowup[2]) ? $last_folowup[2] : '-'; ?></td> -->
                            <td><?php echo $value['status_name']; ?></td>
                            <td><?php echo date("d MMM Y", strtotime($value['created_date'])); ?></td>
                            <td><a
                                    href="<?php echo site_url('enquiries/' . $value["short_name"] . '/view?id=' . $value['id']) ?>"><button
                                        type="button" class="btn btn-sm btn-primary">View</button></a></td>
                        </tr>
                        <?php
            }
            ?>
