...
<div class="row page-titles mx-0">
    <div class="col-sm-6 p-md-0">
        <div class="welcome-text">
            <h4>Al-baraha Un-assigned PCR ORDERS</h4>
            <span>Unassigned PCR Orders</span>
        </div>
    </div>
            ...
            <div class="card-body">
                <table id="datatable" cellpadding="2" cellspacing="1" class="table table-striped">
                  ...
                  <tbody>
                    ...
                    {
                    ?>
                      <tr id="o<?php echo $value['pcr_order_id']; ?>">
                        <td><?php echo $value['pcr_order_id']; ?></td>
                        <td>&nbsp;<?php echo '<strong>'.$value['customer_name'].'</strong><br />'.$value['mobile']; ?></td>
                        <td>
                          <?php 
                          echo $value['category_name']; 
                          echo ($value['subcategory_name']!='')?' -> '.$value['sub_category_name']:"";
                          echo '<br /><strong>Amount:</strong> AED '.$value['total_amount'];
                          echo '<br /><strong>No of examinees:</strong> '.pcr_order_item_count($value['pcr_order_id']);
                          ?>
                        </td>
                        <td>
                          <?php 
                        ...
                        <td>
                          <select onchange="javascript:assign_pcr_csa(<?php echo $value['pcr_order_id']; ?>,this.value,<?php echo $this->auth_user_id; ?>);">
...
<script type="text/javascript">
    ...
    function assign_pcr_csa(item_id,assigned_to,assigned_by) 
    {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          $.ajax({
            url: "<?php echo base_url(); ?>api/v1/assign/pcr_order",
            type: 'POST',
