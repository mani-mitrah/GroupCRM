...
<div class="row page-titles mx-0">
    <div class="col-sm-6 p-md-0">
        <div class="welcome-text">
            <h4><?php echo $website_details['website_name'].' COMPLAINTS'; ?></h4>
            <span>Manage <?php echo $website_details['website_name'].' Complaints'; ?></span>
        </div>
    </div>
</div>
<div class="row">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><a href="<?php echo site_url('complaints/'.$website_details["short_name"].'/view?id='.$value['id'])?>"><button type="button" class="btn btn-sm btn-primary">View</button></a></td>
                      </tr>
                    <?php
                    }
                    ?>
