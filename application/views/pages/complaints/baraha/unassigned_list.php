...
<div class="row page-titles mx-0">
    <div class="col-sm-6 p-md-0">
        <div class="welcome-text">
            <h4>Un-assigned <?php echo $website_details['website_name'].' COMPLAINTS'; ?></h4>
            <span>Manage un-assigned<?php echo $website_details['website_name'].' Complaints'; ?></span>
        </div>
    </div>
</div>
<div class="row">
...
<script type="text/javascript">
  function assign_csa(item_id,assigned_to,assigned_by) 
    {
      //alert("item_id: "+item_id+" assigned_to: "+assigned_to+" assigned_by:"+assigned_by);
      Swal.fire({
        title: 'Please confirm',
        text: "If complaint is assigned to CSA, it cannot be reverted.",
        icon: 'warning',
        ...
        if (result.isConfirmed) {
          ...
          $.ajax({
            url: "<?php echo base_url(); ?>api/v1/assign/complaint",
            type: 'POST',
