                        ...
                        <tr>
                         ...
                         ?></td>
                            ...
                            <?php if($value->id == $en->service_id){?>
                                Assigned
                            <?php }else{?>
                                <a href="#"><button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#myModals<?php echo $value->id;?>" >Assign Group</button></a>
                            <?php }?>
                            ...
                            <?php }else{?>
                                <a href="#"><button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#priority<?php echo $value->id;?>">Priority</button></a>
                            <?php }?>
