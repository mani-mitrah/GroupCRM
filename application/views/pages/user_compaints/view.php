                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo date("d-m-Y h:i:s", strtotime($value->assigned_date));?></td>
                             <td><?php if($value->complaint_status==1){?>
                                Open
                            <?php }elseif($value->complaint_status==2){?>
                                Closed
                            <?php 
                        }
                            else{
                      ...
                      else
                        {
                            ?>
                            <td>
                             <!-- <a href="<?php echo site_url('user_compaints/accept/'.$value->as_id);?>"><button type="button" class="btn btn-sm btn-success">Accept</button></a>
                            <a href="<?php echo site_url('user_compaints/reject/'.$value->as_id);?>"><button type="button" class="btn btn-sm btn-danger">Reject</button></a> -->
...
<div id="status<?php echo $us->as_id;?>" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="<?php echo site_url('user_compaints/update_status');?>" method="post">
      <div class="form-group">
