...
class Auth_Controller extends CI_Controller {
	...
	public $auth_country;
	public $auth_country_code;
	public $auth_otp;
	public $auth_is_mobile_verified;
	public $auth_is_email_verified;
	...
	protected function _set_user_variables()
	{
		...
		$this->auth_user_role = $this->auth_data->role_id;
		...
		$this->auth_country    = $this->auth_data->country;
		$this->auth_country_code    = $this->auth_data->country_code;
		$this->auth_mobile    = $this->auth_data->mobile;
		$this->auth_otp    = $this->auth_data->otp;
		$this->auth_is_mobile_verified    = $this->auth_data->is_mobile_verified;
		$this->auth_is_email_verified    = $this->auth_data->is_email_verified;
		/*$this->auth_company_name    = $this->auth_data->company_name;
		...
		$data = [
			...
			'auth_country'    => $this->auth_country,
			'auth_country_code'    => $this->auth_country_code,
			'auth_mobile'    => $this->auth_mobile,
			'auth_otp'    => $this->auth_otp,
			'auth_is_mobile_verified'    => $this->auth_is_mobile_verified,
			'auth_is_email_verified'    => $this->auth_is_email_verified,
			/*'auth_company_name'    => $this->auth_company_name,
		...
		$this->config->set_item( 'auth_user_role', $this->auth_user_role);
		...
		$this->config->set_item( 'auth_first_name',    $this->auth_first_name );
		$this->config->set_item( 'auth_last_name',    $this->auth_last_name );
		$this->config->set_item( 'auth_country',    $this->auth_country );
		$this->config->set_item( 'auth_country_code',    $this->auth_country_code );
		$this->config->set_item( 'auth_mobile',    $this->auth_mobile );
		$this->config->set_item( 'auth_otp',    $this->auth_otp );
		$this->config->set_item( 'auth_is_mobile_verified',    $this->auth_is_mobile_verified );
		$this->config->set_item( 'auth_is_email_verified',    $this->auth_is_email_verified );
		/*$this->config->set_item( 'auth_company_name',    $this->auth_company_name );
