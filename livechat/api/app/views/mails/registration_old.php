...
<body>
    <table border="0" align="center" width="100%" cellpadding="0" cellspacing="0" class="main-template" bgcolor="#6e6d6d" style="background-color: rgb(110, 109, 109);">
        <tbody>
                ...
                <td align="center" valign="top">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer" style="max-width:590px!important; width: 590px;">
                        <tbody>
                            <tr>
                                <td align="center" valign="top">
                                    <div style="background-color: rgb(0, 0, 0); border-radius: 0px;">
                                        <!--[if mso]>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="rnb-del-min-width" align="center" valign="top" style="min-width:590px;">
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="rnb-container" bgcolor="#0e0e0e" style="background-color: #0e0e0e; border-radius: 0px; padding-left: 20px; padding-right: 20px; border-collapse: separate;">
                                                            <tbody>
                                                                <tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td valign="middle" align="center" style="line-height: 1px;">
                                                                                                        <div style="border-top:0px None #000;border-right:0px None #000;border-bottom:0px None #000;border-left:0px None #000;display:inline-block; " cellspacing="0" cellpadding="0" border="0">
                                                                                                            <div><img width="100" vspace="0" hspace="0" border="0" alt="LetsFAME" style="float: left;max-width:100px;display:block;" class="rnb-logo-img" src="https://img.mailinblue.com/2503215/images/rnb/original/5dd539ba77061ca6ec228490.png"></div>
                                                                                                        </div>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="rnb-del-min-width" align="center" valign="top">
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="rnb-container" bgcolor="#fdfdfd" style="background-color: #fdfdfd; padding-left: 20px; padding-right: 20px; border-collapse: separate; border-radius: 0px; border-bottom: 0px none rgb(200, 200, 200);">
                                                            <tbody>
                                                                <tr>
                                                                    <td height="20" style="font-size:1px; line-height:0px; mso-hide: all;">&nbsp;</td>
                                                                </tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="rnb-force-col" valign="top" style="padding-right: 0px;">
                                                                                        <table border="0" valign="top" cellspacing="0" cellpadding="0" width="100%" align="left" class="rnb-col-1">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td class="content-spacing" style="font-size:14px; font-family:'Lucida Sans Unicode',Lucida Grande,sans-serif, sans-serif; color:#3c4858; line-height: 21px;">
                                                                                                        <div style="text-align: center;">&nbsp;<span style="font-size: 28px; color: rgb(0, 0, 0); background-color: transparent;">Welcome to LetsFAME - World's first exclusive platform for the creative minds!</span></div>
                                                                                                        <div style="text-align: center;">&nbsp;</div>
                                                                                                        <div style="text-align: center;">&nbsp;</div>
                                                                                                        <div><span style="color: rgb(0, 0, 0); font-size: 17px; background-color: transparent;">Hi <?php echo $name; ?>,&nbsp;</span></div>
                                                                                                        <div>&nbsp;</div>
                                                                                                        <div><span style="color:#000000;"><span style="font-size:17px;">Thank you for registering with us. We are so excited to you have on board. You will be the first one to know when we are LIVE! Can't wait for you to start connecting with the creative minds around the World!&nbsp;</span></span></div>
                                                                                                        <div>&nbsp;</div>
                                                                                                        <div>&nbsp;</div>
                                                                                                        <div><span style="font-size: 17px; color: rgb(0, 0, 0); background-color: transparent;">We’re here to help if you need us. Visit www.letsfame.com for more info or contact us.</span></div>
                                                                                                        <div>&nbsp;</div>
                                                                                                        <div>&nbsp;</div>
                                                                                                        <div><span style="color:#000000;"><span style="font-size:17px;"><strong>Stay Tuned!&nbsp;</strong></span></span></div>
                                                                                                        <div>&nbsp;</div>
                                                                                                        <div><span style="color:#000000;"><span style="font-size:17px;">- <em>LetsFAME Team</em></span></span></div>
                                                                                                        <div>&nbsp;</div>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                ...
                                <td align="center" valign="top">
                                    <div style="background-color: rgb(255, 255, 255);">
                                        <table class="rnb-del-min-width rnb-tmpl-width" width="100%" cellpadding="0" border="0" cellspacing="0" style="min-width:590px;" name="Layout_" id="Layout_">
                                            <tbody>
                                                <tr>
                                                    <td class="rnb-del-min-width" align="center" valign="top" bgcolor="#000000" style="min-width: 590px; background-image: url(https://img.mailinblue.com/2503215/images/rnb/original/5dd28b3f37228a9d5b64961b.png); background-position: center bottom; background-size: cover; background-repeat: no-repeat; background-color: rgb(255, 255, 255);">
                                                                        ...
                                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="rnb-columns-container">
                                                                            <tbody>
                                                                                <tr>
                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td valign="middle" align="left" style="font-size:14px; font-family:Arial,Helvetica,sans-serif; color:#888888; line-height: 16px" class="rnb-text-center">
                                                                                                                        <div>
                                                                                                                            <div><span style="color:#FFFFFF;">LetsFAME</span></div>
                                                                                                                            <div><span style="color:#FFFFFF;">Support@letsfame.com</span></div>
                                                                                                                            <div><span style="color:#FFFFFF;">www.letsfame.com</span></div>
                                                                                                                            <div>&nbsp;</div>
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                    ...
                                                                                    <td ng-if="item.text.align=='left'" class="rnb-force-col rnb-social-width" valign="top" style="mso-padding-alt: 0 20px 0 0; padding-right: 15px;">
                                                                                                                                    ...
                                                                                                                                    <tr>
                                                                                                                                        <td style="padding:0px 5px 5px 0px; mso-padding-alt: 0px 2px 5px 0px;" align="left">
                                                                                                                                            <span style="color:#ffffff; font-weight:normal;">
                                                                                                                                                <img alt="Facebook" border="0" hspace="0" vspace="0" style="vertical-align:top;" target="_blank" src="http://img.mailinblue.com/new_images/rnb/theme4/rnb_ico_fb.png"></span>
                                                                                                                                        </td>
                                                                                                                                    </tr>
                                                                                                                                </tbody>
                                                                                                                            </table>
                                                                                                                            ...
                                                                                                                            <table align="left" style="float:left; display: inline-block" border="0" cellpadding="0" cellspacing="0">
                                                                                                                                <tbody>
                                                                                                                                    <tr>
                                                                                                                                        <td style="padding:0px 5px 5px 0px; mso-padding-alt: 0px 2px 5px 0px;" align="left">
                                                                                                                                            <span style="color:#ffffff; font-weight:normal;">
                                                                                                                                                <img alt="Instagram" border="0" hspace="0" vspace="0" style="vertical-align:top;" target="_blank" src="http://img.mailinblue.com/new_images/rnb/theme4/rnb_ico_ig.png"></span>
                                                                                                                                        </td>
                                                                                                                                    </tr>
                                                                                                                                </tbody>
                                                                                                                            </table>
                                                                                                                            ...
                                                                                                                            <table align="left" style="float:left; display: inline-block" border="0" cellpadding="0" cellspacing="0">
                                                                                                                                <tbody>
                                                                                                                                    <tr>
                                                                                                                                        <td style="padding:0px 5px 5px 0px; mso-padding-alt: 0px 2px 5px 0px;" align="left">
                                                                                                                                            <span style="color:#ffffff; font-weight:normal;">
                                                                                                                                                <img alt="YouTube" border="0" hspace="0" vspace="0" style="vertical-align:top;" target="_blank" src="http://img.mailinblue.com/new_images/rnb/theme4/rnb_ico_yt.png"></span>
                                                                                                                                        </td>
                                                                                                                                    </tr>
                                                                                                                                </tbody>
                                                                                                                            </table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="rnb-del-min-width" align="center" valign="top" bgcolor="#f9fafc" style="min-width:590px; background-color: #f9fafc; text-align: center;">
                                                        <table width="590" class="rnb-container" cellpadding="0" border="0" align="center" cellspacing="0" bgcolor="#f9fafc" style="padding-right: 20px; padding-left: 20px; background-image: url(https://img.mailinblue.com/2503215/images/rnb/original/5dd28b3f37228a9d5b64961b.png); background-position: center bottom; background-size: cover; background-repeat: no-repeat; background-color: rgb(255, 255, 255);">
                                                            <tbody>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div style="font-size:14px; color:#888888; font-weight:normal; text-align:center; font-family:Arial,Helvetica,sans-serif;">
                                                                            <div>
                                                                                <div>&nbsp;</div>
                                                                                <div>By joining LetsFAME, you agree to our Terms of Use and Privacy Statement.<br>
                                                                                    <br>
                                                                                    Need any support? Call +918870804444<br>
                                                                                    (or)<br>
                                                                                    Email at us Support@letsfame.com<br>
                                                                                    (or)<br>
                                                                                    Visit www.letsfame.com<br>
                                                                                    <br>
                                                                                    Please do not reply to this email as we are unable to respond<br>
                                                                                    from this email address. If you need help you can always contact us on the<br>
                                                                                    above given information.</div>
                                                                                <div><br>
                                                                                    This email was sent to {{ contact.EMAIL }}</div>
                                                                                <div>You received this email because you are registered with LetsFAME</div>
                                                                                <div>&nbsp;</div>
                                                                            </div>
                                                                        </div>
                                    ...
                                    <div style="background-color: rgb(0, 0, 0);">
                                        <table class="rnb-del-min-width rnb-tmpl-width" width="100%" cellpadding="0" border="0" cellspacing="0" style="min-width:590px;" name="Layout_4" id="Layout_4">
                                            <tbody>
                                                <tr>
                                                    <td class="rnb-del-min-width" align="center" valign="top" style="min-width:590px;">
                                                        <table width="100%" cellpadding="0" border="0" align="center" cellspacing="0" bgcolor="#000000" style="padding-right: 20px; padding-left: 20px; background-color: rgb(0, 0, 0);">
                                                            <tbody>
                                                                <tr>
                                                                    <td height="20" style="font-size:1px; line-height:0px; mso-hide: all;">&nbsp;</td>
                                                                </tr>
