...
class Sms extends REST_Controller
{
    ...
    public function sendOtp_get()
    {
        ...
        //get mobile number
        $mobile_no = $this->mcommon->specific_row_value('users', array('user_id' => $user_id), 'mobile');
        ...
        $otp_template = $this->mcommon->specific_row_value('m_sms_template', array('id' => '1'), 'template_content');
        $otp_message = str_replace("<OTP>", $sent_otp, $otp_template);
        $body_message = "Hello, Your OTP for $company_name is $sent_otp";
