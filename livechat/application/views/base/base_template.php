                                        ...
                                        <div class="card card-body card-bg-5">
                                            ...
                                            <div class="d-flex flex-column align-items-center">
                                                <div class="avatar avatar-lg mb-3">
                                                    <img class="avatar-img" src="<?php echo base_url(); ?>/assets/media/avatar/3.png" alt="">
                                                </div>
                                                ...
                                                <div class="d-flex">
                                                    <button class="btn btn-outline-default mx-1" type="button">
                                                        ...
                                                        <!-- <img class="injectable hw-18 d-sm-inline-block" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/logout.svg" alt=""> -->
                                                        <span>Logout</span> 
                                                    </button>
                                                    <button class="btn btn-outline-default mx-1 d-xl-none" data-profile-edit="" type="button">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable hw-18 d-sm-inline-block" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/cog.svg" alt=""> -->
                                                        <span>Settings</span> 
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item py-2">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/clock.svg" alt=""> -->
                                                    </div>
                                                </li>
                                                <!-- List Group Item End -->
                                                ...
                                                <li class="list-group-item py-2">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/calendar.svg" alt=""> -->
                                                    </div>
                                                </li>
                                                <!-- List Group Item End -->
                                                ...
                                                <li class="list-group-item py-2">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/phone.svg" alt=""> -->
                                                    </div>
                                                </li>
                                                <!-- List Group Item End -->
                                                ...
                                                <li class="list-group-item py-2">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/mail.svg" alt=""> -->
                                                    </div>
                                                </li>
                                                <!-- List Group Item End -->
                                                ...
                                                <li class="list-group-item py-2">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/globe.svg" alt=""> -->
                                                    </div>
                                                </li>
                                                <!-- List Group Item End -->
                                                ...
                                                <li class="list-group-item pt-2">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/home.svg" alt=""> -->
                                                    </div>
                                                </li>
                                                <!-- List Group Item End -->
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item py-2">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./<?php echo base_url(); ?>/assets/media/icons/facebook.svg" alt=""> -->
                                                    </div>
                                                </li>
                                                <!-- List Group Item End -->
                                                ...
                                                <li class="list-group-item py-2">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./<?php echo base_url(); ?>/assets/media/icons/twitter.svg" alt=""> -->
                                                    </div>
                                                </li>
                                                <!-- List Group Item End -->
                                                ...
                                                <li class="list-group-item py-2">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./<?php echo base_url(); ?>/assets/media/icons/instagram.svg" alt=""> -->
                                                    </div>
                                                </li>
                                                <!-- List Group Item End -->
                                                ...
                                                <li class="list-group-item py-2">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./<?php echo base_url(); ?>/assets/media/icons/linkedin.svg" alt=""> -->
                                                    </div>
                                                </li>
                                                <!-- List Group Item End -->
                ...
                <div class="chat-body">
                        ...
                        <div class="media chat-name align-items-center text-truncate">
                            <div class="avatar bg-success text-light d-none d-sm-inline-block mr-3">
                                <span>
                                    ...
                                    <!-- <img class="injectable" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/user-group.svg" alt=""> -->
                                </span>
                            </div>
                        ...
                        <ul class="nav flex-nowrap">
                            <li class="nav-item list-inline-item d-none d-sm-block mr-1">
                                <a class="nav-link text-muted px-1" data-toggle="collapse" data-target="#searchCollapse" href="#" aria-expanded="false">
                                    ...
                                    <!-- <img src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/search.svg" alt="" class="injectable hw-20"> -->
                                </a>
                            </li>
                        ...
                        <div class="container">
                            ...
                            <div class="message-day">
                                ...
                                <div class="message">
                                    ...
                                    <div class="message-options">
                                        <div class="avatar avatar-sm"><img alt="" src="<?php echo base_url(); ?>/assets/media/avatar/1.png"></div>
                                        ...
                                        <div class="dropdown">
                                            <a class="text-muted" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                ...
                                                <!-- Alternate :: External File link -->
                                                <!-- <img class="injectable hw-18" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/dots-horizontal.svg" alt="message options"> -->
                                            </a>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable hw-18 mr-2" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/duplicate.svg" alt="message options"> -->
                                                    <span>Copy</span>
                                                </a>
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    <!-- Default :: Inline SVG -->
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable hw-18 mr-2" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/reply.svg" alt="message replay"> -->
                                                    <span>Replay</span>
                                                </a>
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    <!-- Default :: Inline SVG -->
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable rotate-y hw-18 mr-2" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/reply.svg" alt="message forward"> -->
                                                    <span>Forward</span>
                                                </a>
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    <!-- Default :: Inline SVG -->
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable hw-18 mr-2" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/star.svg" alt="message favourite"> -->
                                                    <span>Favourite</span>
                                                </a>
                                                <a class="dropdown-item d-flex align-items-center text-danger" href="#">
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable hw-18 mr-2" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/trash.svg" alt="message delete"> -->
                                                    <span>Delete</span>
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="message self">
                                    ...
                                    <div class="message-options">
                                        <div class="avatar avatar-sm"><img alt="" src="<?php echo base_url(); ?>/assets/media/avatar/6.png"></div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable hw-18 mr-2" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/pencil.svg" alt="message edit"> -->
                                                    <span>Edit</span>
                                                </a>
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    <!-- Default :: Inline SVG -->
                                ...
                                <div class="message">
                                    ...
                                    <div class="message-options">
                                        <div class="avatar avatar-sm"><img alt="" src="<?php echo base_url(); ?>/assets/media/avatar/7.png"></div>
                                        <span class="message-date">9:12am</span>
                                        <div class="dropdown">
                                            <a class="text-muted" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <!-- Default :: Inline SVG -->
                                ...
                                <div class="message">
                                    ...
                                    <div class="message-options">
                                        <div class="avatar avatar-sm"><img alt="" src="<?php echo base_url(); ?>/assets/media/avatar/2.png"></div>
                                        <span class="message-date">9:12am</span>
                                        <div class="dropdown">
                                            <a class="text-muted" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <!-- Default :: Inline SVG -->
                                ...
                                <div class="message self">
                                    <div class="message-wrapper">
                                        <div class="message-content">I want to be Batman!  I like wearing the cape and the mask.  I think you should be a butterfly.  You are so much shorter than me, and dressed in a pumpkin costume, someone might think you really are one and try to make a pie out of you.</div>
                                    </div>
                                    <div class="message-options">
                                        <div class="avatar avatar-sm"><img alt="" src="<?php echo base_url(); ?>/assets/media/avatar/6.png"></div>
                                ...
                                <div class="message">
                                    ...
                                    <div class="message-options">
                                        <div class="avatar avatar-sm"><img alt="" src="<?php echo base_url(); ?>/assets/media/avatar/5.png"></div>
                                        <span class="message-date">9:12am</span>
                                        <div class="dropdown">
                                            <a class="text-muted" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <!-- Default :: Inline SVG -->
                            ...
                            <div class="message-day">
                                ...
                                <div class="message">
                                    ...
                                    <div class="message-options">
                                        <div class="avatar avatar-sm"><img alt="" src="<?php echo base_url(); ?>/assets/media/avatar/4.png"></div>
                                        <span class="message-date">9:12am</span>
                                        <div class="dropdown">
                                            <a class="text-muted" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <!-- Default :: Inline SVG -->
                                ...
                                <div class="message">
                                    ...
                                    <div class="message-options">
                                        <div class="avatar avatar-sm"><img alt="" src="<?php echo base_url(); ?>/assets/media/avatar/3.png"></div>
                                        <span class="message-date">9:12am</span>
                                        <div class="dropdown">
                                            <a class="text-muted" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <!-- Default :: Inline SVG -->
                                ...
                                <div class="message self">
                                    <div class="message-wrapper">
                                        <div class="message-content">Thank you for offering, Patrick.  However, I will be worried and I will not be able to relax if you and your brother go by yourselves while I stay home.  Let me ask Christine or Ian if one of them can go with both of you.  Then I can stay home and relax.  Christine!  Ian!</div>
                                    </div>
                                    <div class="message-options">
                                        <div class="avatar avatar-sm"><img alt="" src="<?php echo base_url(); ?>/assets/media/avatar/6.png"></div>
                    ...
                    <div class="chat-footer">
                        <div class="attachment">
                            <div class="dropdown">
                                <button class="btn btn-secondary btn-icon btn-minimal btn-sm" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <!-- <img class="injectable hw-20" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/plus-circle.svg" alt=""> -->
                                </button>
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="#">
                                        ...
                                        <!-- <img class="injectable hw-20 mr-2" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/photograph.svg" alt=""> -->
                                        <span>Gallery</span>
                                    </a>
                                    <a class="dropdown-item" href="#">
                                        <svg class="hw-20 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <!-- <img class="injectable hw-20 mr-2" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/volume-up.svg" alt=""> -->
                                        <span>Audio</span>
                                    </a>
                                    <a class="dropdown-item" href="#">
                                        <svg class="hw-20 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <!-- <img class="injectable hw-20 mr-2" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/document.svg" alt=""> -->
                                        <span>Document</span>
                                    </a>
                                    <a class="dropdown-item" href="#">
                                        <svg class="hw-20 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <!-- <img class="injectable hw-20 mr-2" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/user.svg" alt=""> -->
                                        <span>Contact</span>
                                    </a>
                                    <a class="dropdown-item" href="#">
                                        <svg class="hw-20 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <!-- <img class="injectable hw-20 mr-2" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/location-marker.svg" alt=""> -->
                                        <span>Location</span>
                                    </a>
                                    <a class="dropdown-item" href="#">
                                        <svg class="hw-20 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <!-- <img class="injectable hw-20 mr-2" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/chart-square-bar.svg" alt=""> -->
                                        <span>Poll</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="btn btn-primary btn-icon send-icon rounded-circle text-light mb-1" role="button">
                            ...
                            <!-- <img src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/arrow-right.svg" alt="" class="injectable"> -->
                        </div>
                    </div>
                    <!-- Chat Footer End-->
                </div>
                        ...
                        <div class="col">
                            <div class="card card-bg-1 mb-3">
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center">
                                        <div class="avatar avatar-lg mb-3">
                                            <img class="avatar-img" src="<?php echo base_url(); ?>/assets/media/avatar/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="media">
                                        <div class="avatar avatar-primary mr-2">
                                            <span>
                                                ...
                                                <!-- <img class="injectable hw-24" src="./<?php echo base_url(); ?>/assets/media/heroicons/solid/phone-incoming.svg" alt=""> -->
                                            </span>
                                        </div>
                                        ...
                                        <div class="media-options ml-1 d-none d-sm-block">
                                            <button class="btn btn-secondary btn-icon btn-minimal btn-sm text-muted" type="button" >
                                                ...
                                                <!-- <img class="injectable hw-20" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/phone.svg" alt=""> -->
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="media">
                                        <div class="avatar avatar-primary mr-2">
                                            <span>
                                                ...
                                                <!-- <img class="injectable hw-24" src="./<?php echo base_url(); ?>/assets/media/heroicons/solid/phone-outgoing.svg" alt=""> -->
                                            </span>
                                        </div>
                                    ...
                                    <div class="d-flex flex-column align-items-center">
                                        ...
                                        <div class="d-flex mt-2">
                                            <div class="btn btn-primary btn-icon rounded-circle text-light mx-2">
                                                ...
                                                <!-- <img class="injectable hw-24" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/chat.svg" alt=""> -->
                                            </div>
                                            <div class="btn btn-success btn-icon rounded-circle text-light mx-2">
                                                ...
                                                <!-- <img class="injectable hw-24" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/phone.svg" alt=""> -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/clock.svg" alt=""> -->
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/calendar.svg" alt=""> -->
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/phone.svg" alt=""> -->
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/mail.svg" alt=""> -->
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/globe.svg" alt=""> -->
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./<?php echo base_url(); ?>/assets/media/heroicons/outline/home.svg" alt=""> -->
                                        </div>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./<?php echo base_url(); ?>/assets/media/icons/facebook.svg" alt=""> -->
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./<?php echo base_url(); ?>/assets/media/icons/twitter.svg" alt=""> -->
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./<?php echo base_url(); ?>/assets/media/icons/instagram.svg" alt=""> -->
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./<?php echo base_url(); ?>/assets/media/icons/linkedin.svg" alt=""> -->
                                        </div>
                                    </li>
                                </ul>
                            </div>
